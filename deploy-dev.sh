...
# 公開先:     ~/frontier-dakoku.com/public_html/dev
# ブランチ:   dev
# ============================================================

APP_DIR="$HOME/repo/flortia-attendance-dev"
PUBLIC_DIR="$HOME/frontier-dakoku.com/public_html/dev"
...
echo "=========================================="
echo " [dev] デプロイ開始: $(date '+%Y-%m-%d %H:%M:%S')"
echo "=========================================="
...
echo ""
echo "=========================================="
echo " [dev] デプロイ完了: $(date '+%Y-%m-%d %H:%M:%S')"
