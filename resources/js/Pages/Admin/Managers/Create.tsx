...
export default function ManagerCreate({ sections, levels }: Props) {
    ...
    return (
        <AdminLayout header={<h2 className="text-xl font-bold text-gray-800">管理ユーザーを追加</h2>}>
            <Head title="管理ユーザーを追加" />
